...
makepkglist="arcolinux-betterlockscreen arcolinux-logout-git arcolinux-logout-themes-git arcolinux-teamviewer arcolinux-tweak-tool-dev-git arcolinux-tweak-tool-git"
